...
export default function HeroSection({ className = '' }: HeroSectionProps) {
  return (
    <main className={`relative z-10 flex items-center mt-24 justify-left min-h-screen pt-24 lg:mx-48 ${className}`}>
      <div className="text-left max-w-6xl flex flex-col gap-48">        
