  ...
  return (
    <footer className={`bg-gradient-to-br from-[#141825] via-[#0f1419] to-[#0a0e13] relative overflow-hidden ${className}`}>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex items-center gap-3 mb-6">
                <Image src={layoutContent.footer.company.logo} alt="Logo" width={150} height={80}/>
              </div>
              ...
              <div className="flex items-center gap-4">
                {/* Instagram */}
                <Link href={layoutContent.footer.social[0].url} aria-label="Instagram" className="group w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#03438f] transition-colors duration-300">
                ...
                {/* TikTok */}
                <Link href={layoutContent.footer.social[1].url} aria-label="TikTok" className="group w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#03438f] transition-colors duration-300">
                  <svg className="w-5 h-5 text-white group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 group">
                  ...
                  <span className="text-gray-300 group-hover:text-white transition-colors duration-300">{layoutContent.footer.contact.phone}</span>
                </div>
                ...
                <div className="flex items-center gap-3 group">
                  ...
                  <span className="text-gray-300 group-hover:text-white transition-colors duration-300">{layoutContent.footer.contact.email}</span>
                </div>
        ...
        {/* Copyright Section */}
        <div className="py-8  items-center justify-center gap-4">
